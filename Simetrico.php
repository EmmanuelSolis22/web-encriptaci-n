...
<html lang="en">
  ...
  <body>
        ...
        <div class="container-fluid">
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="has.php">Cifrado</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <center><h1 class="mt-5">Cifrado Simetrico</h1></center>

    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-OERcA2EqjJCMA+/3y+gxIOqMEjwtxJY7qPCqsdltbNJuaOe923+mo//f6V8Qbsw3" crossorigin="anonymous"></script>

    <center>
        <form method="post" class="mt-5" action="encriptado.php">        
        ...
        <div>
              <input type="submit" class="btn btn-primary" href ="Simetrico.php" value ="Cifrar "  name ="Cifrar" id="Cifrar" >
    ...
    <form method="post" class="mt-5" action="desencriptado.php">
    ...
    <div  for="colFormLabel" class="col-sm-4 col-form-label">
     ...
     <input type="submit" class="btn btn-primary"  value ="Decifrar "  name ="Decifrar" id="Cifrar" >      

    </form>

    <div  for="colFormLabel" class="col-sm-4 col-form-label">
       <div class="form-floating mb-3">
          <input type="text" class="form-control" name="des" id="des" placeholder="Contraseña" >
